...
using EventOnContiner.Services.CartApi.Infrastructure.Filters;
using Autofac;
...
using EventOnContiner.Services.CartApi.Model;
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            builder.Register(context =>
            {
                var busControl = Bus.Factory.CreateUsingRabbitMq(cfg =>
                {
                    ...
                    cfg.ReceiveEndpoint(host, "EventOnContiner" + Guid.NewGuid().ToString(), e =>
                    {
                        e.LoadFrom(context);
